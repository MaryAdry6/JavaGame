...
public class MON_WolfMountain extends Entity
{
    BufferedImage wolf_back, wolf_front, wolf_left, wolf_right;


    public MON_WolfMountain(GamePanel gp)
    {
        super(gp);
    ...
    public void getImage()
    {
        ...
        try
        {
            wolf_back = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_BACK2.png"));
            ...
            wolf_front = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_FRONT2.png"));
            ...
            wolf_right = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_RIGHT2.png"));
            ...
            wolf_left = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_LEFT2.png"));
