...
public class MON_SpiderMountain extends Entity {
    BufferedImage spider_back, spider_front, spider_left, spider_right;


    public MON_SpiderMountain(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        ...
        try {
            spider_back = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel2-Left.png"));
            ...
            spider_front = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel2-Right.png"));
            ...
            spider_right = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel2-Right.png"));
            ...
            spider_left = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel2-Left.png"));
