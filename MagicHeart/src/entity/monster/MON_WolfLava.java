...
public class MON_WolfLava extends Entity
{
    BufferedImage wolf_back, wolf_front, wolf_left, wolf_right;


    public MON_WolfLava(GamePanel gp)
    {
        super(gp);
    ...
    public void getImage()
    {
        ...
        try
        {
            wolf_back = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_BACK3.png"));
            ...
            wolf_front = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_FRONT3.png"));
            ...
            wolf_right = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_RIGHT3.png"));
            ...
            wolf_left = ImageIO.read(getClass().getResourceAsStream("/monster/wolf/wolf_official/WOLF_LEFT3.png"));
