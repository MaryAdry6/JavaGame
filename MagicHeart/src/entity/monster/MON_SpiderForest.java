...
public class MON_SpiderForest extends Entity
{
    BufferedImage spider_back, spider_front, spider_left, spider_right;


    public MON_SpiderForest(GamePanel gp)
    {
        super(gp);
    ...
    public void getImage()
    {
        ...
        try
        {
            spider_back = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel1-Left.png"));
            ...
            spider_front = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel1-Right.png"));
            ...
            spider_right = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel1-Right.png"));
            ...
            spider_left = ImageIO.read(getClass().getResourceAsStream("/monster/spider/PaianganLevel1-Left.png"));
